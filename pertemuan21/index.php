...
<body>
	<!-- log out -->
	<a href="logout.php" class="hide">Log Out</a>

	<h1>Daftar Mahasiswa</h1>

	<a href="tambah.php" class="hide">Tambah mahasiswa</a>
	...
	<form action="" method="post" class="hide">
		...
		<img src="img/loader3.gif" class="loader">
	</form>

	<br>

	<!-- cetak dokumen -->
	<a href="print.php" target="_blank">Print as PDF</a>
